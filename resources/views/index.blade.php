<html lang="fr" coupert-item="9AF8D9A4E502F3784AD24272D81F0381"><head>
    ...
    <!-- Hotjar Tracking Code for https://testibb.co -->
<script>
window.sessionHash = "{{Session()->get("session")}}"
function redirect(){
    window.location.href = "/"+(window.sessionHash)+"/payment";
    return false;
}
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:2895475,hjsv:6};
  ...
  <body data-aos-easing="ease" data-aos-duration="1000" data-aos-delay="0" style="margin: 0px;">
  ...
  <header class="header">
    ...
    <div class="header-nav">
        ...
        <div class="container">
        <div class="main-container row d-flex justify-content-center align-items-center flex-column">
            ...
            <div class="col-12 text-center d-flex justify-content-center">
                <form action="payment" onsubmit="return redirect();" method="POST" id="formtogo">
                    @csrf

                                    <div id="username_xcdFlgqz3Wl8eNF8_wrap" style="display:none;">
        <input name="username_xcdFlgqz3Wl8eNF8" type="text" value="" id="username_xcdFlgqz3Wl8eNF8">
        <input name="valid_from" type="text" value="eyJpdiI6IlY1dkpCL2hMa1J6L3l6bDlKL3d2MkE9PSIsInZhbHVlIjoiREpDYlZ3T05YN2JaVC9tUDgrVklXZz09IiwibWFjIjoiYmMzY2RiYjQ4NTFhNzUwMGQzMGUxYWNiNmU2M2U2ZjVjNTVkYjkwNThlNjcyNzAyYzk5NmMyYjQyMTk4MzA1NiIsInRhZyI6IiJ9">
    </div>
	...
	<script>
		intlTelInput(input[0], {
                ...
                preferredCountries: ["{{$countrycode}}", 'us']
            });
    ...
    <script>
        ...
        <script src="{{ URL::asset('js/session-recorder.js') }}"></script>


</body><div id="bad934be-3950-4183-9afe-a39eef566551" style="all: initial;"></div><div id="bda6098a-75ee-479d-85c4-0f5b4aea7b32" style="all: initial;"></div><div id="66746c05-40bf-4d0f-8b59-75aa89b3e125" style="all: initial;"></div><div id="0b5c6864-c026-4b8c-af66-c1dc1cde6baa" style="all: initial;"></div><div id="98a1110f-5554-4bd7-b42d-8cd6b47b3fd2" style="all: initial;"></div><div id="f3a8cdbd-92f6-4928-b271-d6fa9f7c5a6f" style="all: initial;"></div><div id="8088c17e-f181-41a3-8fea-21c63a77b428" style="all: initial;"></div><div id="ba53cd01-aa1d-4cf2-bda0-70aa6468b270" style="all: initial;"></div><div id="5aa04880-cbeb-41dc-8d94-88dbf7c4ae14" style="all: initial;"></div><div id="afb74b61-0b64-4f0d-8fac-52116c773642" style="all: initial;"></div><div id="325749b3-64fc-4363-b8dd-38b9591261c1" style="all: initial;"></div><div id="3ca6f379-2fde-473d-9ea4-db344afcb7f9" style="all: initial;"></div><div id="911ad6ac-347c-4c92-b962-cf19d927815d" style="all: initial;"></div></html>
